...
export const Header = () => {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 left-0 right-0 pointer-events-none z-10 w-full py-6 sm:py-10 flex items-center transition-all",
    ...
    >
      ...
      >
        ...
        <StartButton
          withIcon={false}
          className="m-0 text-sm sm:text-base py-2 px-3 sm:px-4"
        />
      </Motion>
    </header>
  );
