...
export const Reviews = () => {
  const reviews = [
    ...
    {
      name: "Gabriel Dias",
      photo: "gabriel-dias.webp",
      content: "Gostei muito do curso, muito prático e direto ao ponto. Aprendi muitas coisas que irei implementar nos meus projetos daqui para frente. Vlw GB!"
    },
    {
